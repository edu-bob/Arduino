...
// PROGMEM puts the array in flash RAM, though the strings are still in RAM

const note_t Music::notes[] PROGMEM = {
  { "b0", 31 },
  { "c1", 33 },
  { "cs1", 35 },
  { "dd1", 35 },
...
const note_t Music::duration[] PROGMEM = {
  { "s", 16 },
  { "8", 8 },
  { "q", 4 },
  { "h", 2 },
...
#define MUSIC_TWEEN_TIME 25

void Music::setup(int _pin)
{
...
//  Serial.print(note);Serial.print(" ");Serial.println(noteDuration);
  ...
  delay(noteDuration+MUSIC_TWEEN_TIME);
